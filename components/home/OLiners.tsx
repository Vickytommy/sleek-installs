...
import OLinerPatterns from './OLinerPatterns';
  ...
  return (
    ...
    >
      <Image 
        ...
        source={require("@/assets/images/oliners/hero.jpeg")} 
      />
      <View style={styles.heroImgOverlay}>
        <Text style={styles.headerText}>Above-Ground Pools Liners</Text>
      </View>
