...
const shapeList = [
  {
    id: 0,
    name: 'Butterfly',
    url: require("@/assets/images/iliners/butterfly.jpg"),
    specs: `Tile Height: 8-1/4"`,
    mainCategory: 'Inground Pool Liner',
  ...
  {
    id: 1,
    name: 'Bali / Blue Granite',
    url: require("@/assets/images/iliners/bali.jpg"),
    specs: `Tile Height: 8-1/4"`,
    mainCategory: 'Inground Pool Liner',
    // filterCategory: 'Modern Freeform',
  ...
  },
  {
    id: 2,
    name: 'Blue Bonair',
    url: require("@/assets/images/iliners/blue_bonair.jpg"),
    specs: `Tile Height: 8-1/4"`,
    mainCategory: 'Inground Pool Liner',
    // filterCategory: 'Modern Freeform',
    description: 'The Island Wave pattern softens your entry to the water with a tapestry that evokes a sense of unity and strength',
  },
  {
    id: 4,
    name: 'Cayman',
    url: require("@/assets/images/iliners/cayman.jpg"),
    specs: `Tile Height: 8-1/4"`,
    mainCategory: 'Inground Pool Liner',
    // filterCategory: 'Modern Freeform',
    description: 'The Island Wave pattern softens your entry to the water with a tapestry that evokes a sense of unity and strength',
  },
  {
    id: 5,
    name: 'Durango',
    url: require("@/assets/images/iliners/durango.jpg"),
    specs: `Tile Height: 8-1/4"`,
    mainCategory: 'Inground Pool Liner',
    // filterCategory: 'Modern Freeform',
    description: 'The Island Wave pattern softens your entry to the water with a tapestry that evokes a sense of unity and strength',
  },
  {
    id: 6,
    name: 'Disco',
    url: require("@/assets/images/iliners/disco.jpg"),
    specs: `Tile Height: 8-1/4"`,
    mainCategory: 'Inground Pool Liner',
    // filterCategory: 'Modern Freeform',
    description: 'The Island Wave pattern softens your entry to the water with a tapestry that evokes a sense of unity and strength',
...
const ILinerPatterns = (Props: any) => {
